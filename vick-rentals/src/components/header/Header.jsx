        ...
        <Row>
          <Col lg='6' md='6' sm='6'>
            <div className="header__top__left">
              ...
              <i class="ri-phone-line"></i> +2349063722517
              </span>
            </div>
          </Col>
                ...
                <div className="menu">
                  {
                    navLinks.map((item, index) =>(
                      <NavLink to={item.path} className={navClass=>navClass.isActive ? 'nav__active nav__item' : "nav__item"}
